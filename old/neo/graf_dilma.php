...
<div id="geral">
 ...
 <div id="wrapper">
    ...
    <div id="conteudo">
      ...
      <div id="info2">
      	<h2>Gráfico Dilma</h2>
      	<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.neofluxo.net%2Fgraf_dilma.php&amp;layout=box_count&amp;show_faces=true&amp;width=150&amp;action=like&amp;font=arial&amp;colorscheme=light&amp;height=65" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:67px;" allowTransparency="true" align="right" ></iframe> 
      	<br/><br/>
      	
     	 <iframe src="resource_api/dilma_scale.html" width="650" height="500" ></iframe><br/>
     	 
     	 	<div id="nav"> <a href="visu.php"><img src="imagens/seta_do.png" width="15" height="15" alt="página principal" /></a><a href="graf_marina.php"><img src="imagens/seta_ri.png" width="15" height="15" alt="gráfico Marina"/></a></div>
