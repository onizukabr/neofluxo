 ...
 <div id="wrapper">
    ...
    <div id="conteudo">
      ...
      <div id="info2">
      	...
      	<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.neofluxo.net%2Frede2_serra.php&amp;layout=box_count&amp;show_faces=true&amp;width=150&amp;action=like&amp;font=arial&amp;colorscheme=light&amp;height=65" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:67px;" allowTransparency="true" align="right" ></iframe> 
      	<br/><br/>
      	
     	 <iframe src="resource_api/serra_redes2.html" width="650" height="650" ></iframe><br/>
     	 
     	 <div id="nav"><a href="rede2_marina.php"><img src="imagens/seta_le.png" width="15" height="15"/></a><a href="visu.php"><img src="imagens/seta_do.png" width="15" height="15"/></a></div>
     </div>
