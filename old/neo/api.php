...
<link href="aba_style.css" rel="stylesheet" type="text/css" />


<script src="glow/1.7.2/core/core.js"></script>
<script src="contato_panel.js"></script>
...
<div id="geral">
 ...
 <div id="wrapper">
   ...
   <div class="global-div">
     ...
     <ul class="abas">
    	<li><a href="#textos1">Bancos de dados</a></li>
    	<li><a href="#textos2">Plataforma aberta</a></li>
    	<li><a href="#textos3">Política de API</a></li>
    	<li><a href="#textos4">Desenvolvedores</a></li>
    	<li><a href="#textos5">Cadastro</a></li>
