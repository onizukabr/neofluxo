...
<div id="geral">
 ...
 <div id="wrapper">
    ...
    <div id="conteudo">
      ...
      <div class="info">
      <h2>Some data visualizations of the first vote:</h2><br/>
      <br/>
      <br/>
      <ul>
      	<div id="visu1">
      	<li><strong>Tag Clouds</strong></li><br/>
      		<ul>
        ...
        <div id="visu2">
        <li><strong>Graphics</strong></li><br/>
        	<ul>
        ...
        <div id="visu3">
        <li><strong>Social Media v.1</strong></li><br/>
        	<ul>
        ...
        <div id="visu4">
        <li><strong>Social Media v.2</strong></li><br/>
        	<ul>
