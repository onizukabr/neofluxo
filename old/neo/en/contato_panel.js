...
var hasStorage = window.localStorage ? true : false;
  ...
  // Add the extra triggers - this is for purposes of the demo only
    ...
    var contactLink = glow.dom.create('<p><a href="http://www.casperlibero.edu.br/noticias/index.php/1969/12/31/neofluxo-disponibiliza-banco-de-dados-e-apis-sobre-redes-sociais-nas-eleicoes-presidenciais,n=4214.html"><strong>Press Room</strong></a></p>');
