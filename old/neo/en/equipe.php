...
<div id="geral">
 ...
 <div id="wrapper">
		...
		<ul id="menu">
			...
			<li class="contato"><a class="selected" href="equipe.php">Team</a></li>
		</ul>
  </div>
  ...
  <div class="global-div">
     ...
     <ul class="abas">
    	<li><a href="#textos1">About Teccred</a></li>
    	<li><a href="#textos2">Project participants</a></li>
	</ul>
    ...
    <?php include("teccred.php");?>
    
    <?php include("partic.php"); ?>
