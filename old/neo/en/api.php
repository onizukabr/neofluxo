...
<div id="geral">
 ...
 <div id="wrapper">
		...
		<ul id="menu">
			...
			<li class="api"><a class="selected" href="api.php">API</a></li>
   ...
   <div class="global-div">
     ...
     <ul class="abas">
    	<li><a href="#textos1">Databases</a></li>
    	<li><a href="#textos2">Open platform</a></li>
    	<li><a href="#textos3">API's Policy</a></li>
    	<li><a href="#textos4">Developers</a></li>
...
<div id="cont">
    ...
    <?php include("aberta.php"); ?>
    
    <?php include("politica.php"); ?>    
    
    <?php include("desenv.php"); ?>
