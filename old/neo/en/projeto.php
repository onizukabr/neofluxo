...
<div id="geral">
 ...
 <div id="wrapper">
		...
		<ul id="menu">
			...
			<li class="projeto"><a class="selected" href="projeto.php">Project</a></li>
...
<div class="global-div">
     ...
     <ul class="abas">
    	<li><a href="#textos1">Introduction</a></li>
    	<li><a href="#textos2">Objectives</a></li>
    	<li><a href="#textos3">Methodology</a></li>
    	<li><a href="#textos4">Stages </a></li>
