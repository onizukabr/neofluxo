...
<head>
<meta name="description" content="NeoFluxo is a system that identifies the behavior of information flow in social networks during the brazilian election process 2010." />
<meta name="keywords" content="neofluxo, twitter, politics, 2010 elections, serra, marina, dilma, data flows, data visualization, search, teccred" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

<title>NeoFluxo - Brazilian Presidential Elections 2010</title>
...
<div id="geral">
  ...
  <div id="lingua">
	...
	<div id="en"><a href="index.php"><img src="imagens/eng.jpg" width="20" height="15"/></a></div>
  </div>	
  
  <p class="contact trigger"><a href="#">contact</a></p>
 ...
 <div id="wrapper">
		...
		<ul id="menu">
			...
			<li class="projeto"><a href="projeto.php">Project</a></li>
			<li class="visu"><a href="visu.php">Visualization</a></li>
			<li class="api"><a href="api.php">API</a></li>
			<li class="contato"><a href="equipe.php">Team</a></li>
		</ul>
  </div>
...
<div id="corre">
   ...
   <script type="text/javascript">
    if(!window.slider) var slider={};slider.data=[{"id":"slide-img-1","client":"visualization:","desc":"Dilma's Social Media"},{"id":"slide-img-2","client":"visualization:","desc":"Dilma's tag cloud"},{"id":"slide-img-3","client":"visualization:","desc":"Dilma's Graphics"},{"id":"slide-img-4","client":"visualization:","desc":"Dilma's Social Media"},{"id":"slide-img-5","client":"visualization:","desc":"Serra's Social Media"},{"id":"slide-img-6","client":"visualization:","desc":"Serra's tag cloud"},{"id":"slide-img-7","client":"visualization:","desc":"Serra's Graphics"},{"id":"slide-img-8","client":"visualization:","desc":"Serra's Social Media"},{"id":"slide-img-9","client":"visualization:","desc":"Marina's Social Media"},{"id":"slide-img-10","client":"visualization:","desc":"Marina's tag cloud"},{"id":"slide-img-11","client":"visualization:","desc":"Marina's Graphics"},{"id":"slide-img-12","client":"visualization:","desc":"Marina's Social Media"}];
   </script>
  </div></div><!--/header-->
</div>  
  ...
  <div id="logos">
        ...
        <div id="casper"><a href="http://www.casperlibero.edu.br/canais/index.php/pos-graduacao/index,c=177.html" target="_blank"><img src="imagens/casper.png" alt="logo_casper" width="40" height="40" align="left"/></a></div>
        <h1>Create by:</h1>
...
<div id="rodape"> <a href="index.php"> Home </a><a href="projeto.php"> Project </a><a href="visu.php"> Visualizations </a><a href="api.php"> API </a><a href="equipe.php"> Team </a><a href="api.php#textos4"> Developers </a><a href="mailto:walterlima@pq.cnpq.br"> Contact </a>
</div>
